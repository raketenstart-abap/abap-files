CLASS zcl_file_sap DEFINITION
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS file_extension TYPE string VALUE '.sap' ##NO_TEXT.
    CONSTANTS file_filter TYPE string VALUE '*.sap' ##NO_TEXT.
    CONSTANTS file_type TYPE string VALUE 'SAP' ##NO_TEXT.
...
CLASS ZCL_FILE_SAP IMPLEMENTATION.
